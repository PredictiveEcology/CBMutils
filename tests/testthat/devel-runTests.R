...
testthat::test_local(filter = "Boudewyn_subsetTables")
testthat::test_local(filter = "CBM-CBM_core_db")
testthat::test_local(filter = "CBM-DB_disturbances")
testthat::test_local(filter = "CBM-DB_species")
testthat::test_local(filter = "CBM-plots_CBM_core-results")
testthat::test_local(filter = "CBM-plots_cTransfersAlluvial")
testthat::test_local(filter = "CBM-tools_adjustCohortAges")
testthat::test_local(filter = "CBM-tools_calcC")
testthat::test_local(filter = "CBM-tools_calcRootC")
